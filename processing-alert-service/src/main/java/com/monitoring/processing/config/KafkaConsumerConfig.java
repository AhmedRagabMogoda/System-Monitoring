package com.monitoring.processing.config;
 ...
 * Configures reactive consumption of metric events with manual acknowledgment.
 */
...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, MetricEvent> consumerFactory() {
        ...
        config.put(JsonDeserializer.TRUSTED_PACKAGES, "com.monitoring.common.dto");
        config.put(JsonDeserializer.VALUE_DEFAULT_TYPE, MetricEvent.class.getName());
